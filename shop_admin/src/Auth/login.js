...
export default function Login() {
	...
	const [, setCookie] = useCookies(['theeasylearn']);
									...
									<div className="m-sm-3">
										...
										<form method='post' onSubmit={doLogin}>
											<div className="mb-3">
												...
												<input className="form-control form-control-lg" type="email" name="email" placeholder="Enter your email" onChange={(e) => setEmail(e.target.value)} value={email} />
											</div>
											<div className="mb-3">
